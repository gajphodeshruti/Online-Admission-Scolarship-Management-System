// $("#btn").hide();
	...
	if(studentname=="") {
				...
				document.getElementById("student_nameMsg").innerHTML="Enter Your Name";
				document.getElementById("student_nameMsg").setAttribute("style","color:red;font-size:13px;");
				return false;
	}
...
function validateName(){
    ...
    if (name === '') {
        $("#student_name").css("border", "1px solid red");
        $("#student_nameMsg").html("Enter Your Name");
        $("#student_nameMsg").css("color", "red").css("font-size", "14px");
        return false;
    } else {
        $("#student_name").css("border", "1px solid green");
        $("#student_nameMsg").html(""); // Clear the error message
        return true;
    }
}
