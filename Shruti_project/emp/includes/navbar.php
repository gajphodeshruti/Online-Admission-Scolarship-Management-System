      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">            
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" title="PB Dashboard">Employee Panel</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active"><a href="index.php"><i class="glyphicon glyphicon-th"></i> Dashboard</a></li>
                     <li><a href="schooldetails.php"> School Detail </a></li>
                      <li><a href="referencesdetail.php">References</a></li>
...
$sql="select * from tbl_employee where contactno='" .$user."'";
